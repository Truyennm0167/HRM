...
urlpatterns = [
    ...
    path('attendance/get-data/', management_views.get_attendance_data, name='get_attendance_data'),  # Backward compatibility
    ...
    path('payroll/get-data/', management_views.get_payroll_data, name='get_payroll_data'),  # Backward compatibility
    path('payroll/save/', management_views.save_payroll, name='save_payroll'),
    path('payroll/delete/', management_views.delete_payroll, name='delete_payroll'),  # Backward compatibility
    ...
    path('recruitment/jobs/<int:job_id>/delete/', management_views.delete_job, name='delete_job'),  # Backward compatibility
